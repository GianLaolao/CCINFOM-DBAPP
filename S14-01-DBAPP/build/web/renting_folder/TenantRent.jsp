<%-- 
    Document   : TenantRent
    Created on : 11 13, 23, 10:43:59 PM
    Author     : ccslearner
--%>
...
<html>
    ...
    <body>
            ...
            <form action="trentProcess.jsp">
            <%
                    S.checkSpaces();
                    T.getTenants();
                    S.getSpaceInfo();
            %>
                Tenant ID: <input type="text" id="tenantInput" name="tenantInput" required>
            <%           
